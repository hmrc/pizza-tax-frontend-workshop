...
import uk.gov.hmrc.pizzatax.views.html.PageNotFoundErrorView
import uk.gov.hmrc.pizzatax.views.html.components.h1
import uk.gov.hmrc.pizzatax.views.html.templates.{ErrorTemplate, GovukLayoutWrapper}
...
)(implicit val config: Configuration, ec: ExecutionContext, appConfig: uk.gov.hmrc.pizzatax.config.AppConfig)
